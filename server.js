...
createServer({
    ...
    seeds(server) {
        server.create("album", { id: "1", name: "Bartók: Concerto for Orchestra", price: 9, description: "Karina Canellakis offers the first fruit of her exclusive Pentatone collaboration with a recording of Bartók’s 4 Orchestral Pieces and Concerto for Orchestra, together with the Netherlands Radio Philharmonic Orchestra, of which she is the Chief Conductor. The 4 Orchestral Pieces have a strong affinity with the stage works Duke Bluebeard’s Castle and The Wooden Prince, conceived in the same period. The Concerto for Orchestra is one of Bartóks final works, full of folk tunes, and utterly colourful and virtuosic for all the instruments. As such, it’s an ideal piece to showcase the congeniality between the Netherlands Radio Philharmonic Orchestra and its star Chief Conductor.", imageUrl: "https://alexandralanorias.github.io/images/itude/canellakis-bartok-concerto.jpg", type: "new" })
